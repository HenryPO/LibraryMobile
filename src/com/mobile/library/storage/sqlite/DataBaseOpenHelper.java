...
public class DataBaseOpenHelper extends SQLiteOpenHelper {
	...
	/**
	 * 
	 * @Title: insert @Description: 插入数据 @param @param table @param @param
	 *         contentValues 设定文件 @return void 返回类型 @author lihy @throws
	 */
	...
	/**
	 * 
	 * @Title: update @Description: 更新 @param @param table @param @param
	 *         values @param @param whereClause @param @param whereArgs
